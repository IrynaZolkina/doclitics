...
import Popup from "@/components/auth/login/Popup";
import { usePathname, useRouter, useSearchParams } from "next/navigation";
import { apiFetch } from "@/lib/apiFetch";
import PopupLogin, { showLoginPopup } from "@/components/auth/login/PopupLogin";
// import PopupLoginInner from "@/components/auth/login/PopupLoginInner";
...
import Arrowleft from "../../../components/pages-components/summary-params/pdfviewer/Arrowleft";
import Arrowright from "../../../components/pages-components/summary-params/pdfviewer/Arrowright";
import ArrRight from "../../../components/pages-components/summary-params/pdfviewer/ArrRight";
import ArrLeft from "../../../components/pages-components/summary-params/pdfviewer/ArrLeft";
...
export default function ViewerPage() {
  ...
  useEffect(() => {
    if (chosenFile) {
      viewer.loadPdfFromFile(chosenFile);
    }
  }, [chosenFile]);
